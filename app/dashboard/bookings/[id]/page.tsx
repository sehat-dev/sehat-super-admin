...
export default function BookingDetailPage() {
  ...
  const cancelBooking = async () => {
    ...
    if (reason !== null) {
      try {
        await superAdminAPI.cancelBooking(
          params.id as string,
          reason || undefined
        );
        fetchBooking();
            ...
            <Card>
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  {booking.serviceDetails.testsIncluded &&
                    booking.serviceDetails.testsIncluded.length > 0 && (
                      <div>
                        <p className='text-sm text-gray-600 mb-2'>
                          Tests Included
                        </p>
                        <ul className='list-disc list-inside space-y-1'>
                          {booking.serviceDetails.testsIncluded.map(
                            (test, index) => (
              ...
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <p className='font-medium'>
                      {booking.patientDetails.age} years
                    </p>
                  </div>
                  <div>
